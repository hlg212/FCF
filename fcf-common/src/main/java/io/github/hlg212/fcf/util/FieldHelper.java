...
public class FieldHelper {
     ...
     *
     */
    public static  io.github.hlg212.fcf.annotation.Field getFieldAnnotation(Class<?> clazz, String fieldName) {
        return getInstance()._getFieldAnnotation(clazz,fieldName);
    }


    @Cacheable(key = "#p0+ '_(anno)'+ #p1")
    public  io.github.hlg212.fcf.annotation.Field _getFieldAnnotation(Class<?> clazz,String fieldName){
        Field field = getInstance()._getField(clazz,fieldName);
        return field.getDeclaredAnnotation( io.github.hlg212.fcf.annotation.Field.class);
    }
