 ...
 * Package Name:com.hlg.fcf.base.util 
...
public class TreeHelper {
     ...
     * @author ccfhn-xiequn 
	 */
	public static NodeParam createNodeParam() {
     ...
     * @author ccfhn-xiequn 
	 */
	public static NodeParam createNodeParam(String nodeName, String parentName, String childListName) {
		return new NodeParam(nodeName, parentName, childListName);
	}
     ...
     * @author ccfhn-xiequn 
	 */
	public static NodeParam createNodeParam(String nodeName, String parentName, String childListName, String isLeaf) {
		return new NodeParam(nodeName, parentName, childListName, isLeaf);
	}
