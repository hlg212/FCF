...
@Aspect
@Component
@ConditionalOnBean( io.github.hlg212.fcf.core.conf.CacheConfig.class)
public class CacheRemoveInterceptor implements Ordered{
	...
	@Pointcut("@annotation( io.github.hlg212.fcf.annotation.CacheRemove)")
	public void method() {
