...
import io.hlg212.fcf.core.cachex.ExCacheErrorHandler;
import io.hlg212.fcf.core.cachex.NoneCache;
import io.hlg212.fcf.model.Model;
import io.hlg212.fcf.service.CurdService;
import io.hlg212.fcf.util.ParameterizedTypeHelper;
...
@Aspect
@Component
@ConditionalOnBean(io.hlg212.fcf.core.conf.CacheConfig.class)
