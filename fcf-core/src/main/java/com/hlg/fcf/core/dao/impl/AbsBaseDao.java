 ...
 * Package Name:com.hlg.fcf.core.dao.impl
 * Date:2016-12-27 16:32:33
 * Copyright (c) 2016, 航天长峰湖南分公司  All Rights Reserved.
 */
package com.hlg.fcf.core.dao.impl;

import com.hlg.fcf.core.util.QueryPropertyParseUtils;
import com.hlg.fcf.core.util.TableHelper;
import com.hlg.fcf.dao.BaseDao;
import com.hlg.fcf.dao.QueryAuthInterface;
...
//			}
    ...
    private Map<String, String> getFieldAsMapping() {
        if (asMap == null) {
            Class<T> clazz = getModelClass();
            asMap = DbUtils.getFieldAsMapping(clazz);
        }
        return asMap;
    }
