package com.hlg.fcf.core.mybatis.plus;
 ...
 *  plus 集成增强
 *
 * ClassName: DaoMybatisMapperAnnotationBuilder
 * date: 2019年7月10日 上午8:50:16
 *
 * @author huangligui
 */
public class DaoMybatisMapperAnnotationBuilder extends MapperAnnotationBuilder {
    ...
    public DaoMybatisMapperAnnotationBuilder(MybatisConfiguration configuration, Class<?> type) {
    ...
    public void parse() {
        ...
        if (!this.configuration.isResourceLoaded(resource)) {
            ...
            if (GlobalConfigUtils.isSupperMapperChildren(this.configuration, this.type) || BaseDao.class.isAssignableFrom(this.type)) {
