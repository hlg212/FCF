...
import com.hlg.fcf.annotation.DataSource;
...
public class DetermineDataSourceInterceptor {
	...
	@Pointcut("@annotation(com.hlg.fcf.annotation.DataSource) || @annotation(org.springframework.transaction.annotation.Transactional)")
