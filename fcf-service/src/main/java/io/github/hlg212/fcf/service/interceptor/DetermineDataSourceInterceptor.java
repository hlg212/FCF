package  io.github.hlg212.fcf.service.interceptor;
...
public class DetermineDataSourceInterceptor {
	...
	@Pointcut("@annotation( io.github.hlg212.fcf.annotation.DataSource) || @annotation(org.springframework.transaction.annotation.Transactional)")
