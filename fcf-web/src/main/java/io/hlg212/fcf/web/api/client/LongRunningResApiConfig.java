 ...
 * Package Name:io.hlg212.fcf.web.api.client
...
import io.hlg212.fcf.model.ga.LongRunningRes;
...
public class LongRunningResApiConfig {
    ...
    @CacheConfig(cacheNames = io.hlg212.fcf.cache.Constants.LongRunningRes)
    public interface LongRunningResApi extends io.hlg212.fcf.api.LongRunningResApi<LongRunningRes> {

        @RequestMapping(value="/getAllLongRunningRes",method=RequestMethod.GET)
        @CacheableReadOnly(key =  io.hlg212.fcf.cache.Constants.LongRunningResKey.getAllLongRunningRes_spel)
        @Override
