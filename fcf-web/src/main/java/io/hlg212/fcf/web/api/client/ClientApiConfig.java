...
import io.hlg212.fcf.model.basic.Client;
...
class ClientApiConfig {
    ...
    @CacheConfig(cacheNames = io.hlg212.fcf.cache.Constants.Client)
    public interface ClientApi extends io.hlg212.fcf.api.ClientApi<Client>{
        ...
        @CacheableReadOnly(key = io.hlg212.fcf.cache.Constants.ClientKey.getAuthoritysByKhdid_spel)
        @Override
