...
class AppApiConfig {
    ...
    @CacheConfig(cacheNames = io.hlg212.fcf.cache.Constants.App)
    public interface AppApi  extends io.hlg212.fcf.api.AppApi<App>{
        ...
        @CacheableReadOnly(key = io.hlg212.fcf.cache.Constants.AppKey.getAppByCode_spel)
        @Override
