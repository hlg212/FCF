...
import io.hlg212.fcf.model.ga.Route;
...
class RouteApiConfig {
    ...
    @CacheConfig(cacheNames = io.hlg212.fcf.cache.Constants.Route)
    public interface RouteApi extends io.hlg212.fcf.api.RouteApi<Route> {

        @RequestMapping(value="/getAllRoutes",method=RequestMethod.GET)
        @CacheableReadOnly(key =  io.hlg212.fcf.cache.Constants.RouteKey.getAllRoutes_spel)
        @Override
