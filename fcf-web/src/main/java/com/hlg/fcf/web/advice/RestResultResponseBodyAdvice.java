...
import com.hlg.fcf.annotation.RestBody;
...
import com.hlg.fcf.util.HandlerTypePredicateHelper;
...
public class RestResultResponseBodyAdvice implements ResponseBodyAdvice<Object> {
	...
	public Object beforeBodyWrite(Object body, MethodParameter returnType, MediaType selectedContentType,
		...
		response.getHeaders().add(FrameCommonConstants.HTCF_FEIGN_REQUEST_KEY, "true");
	...
	/*private List<String> getScanPackages() {
		...
		scanPackages = AutoConfigurationPackages.get(SpringUtils.getBeanFactory());
		return scanPackages;
	}*/
}
