...
import com.hlg.fcf.Task;
import com.hlg.fcf.annotation.TaskRegister;
import com.hlg.fcf.api.common.TaskApi;
...
public class TaskController implements TaskApi {
	...
	public String execute(String beanName, String param) {
		Task task = (Task)SpringUtils.getBean(beanName);
	...
	public List<TaskInfo> getTasks() {
		...
		Map<String,Task> beans =  SpringUtils.getApplicationContext().getBeansOfType(Task.class);
