 ...
 * Package Name:com.hlg.fcf.web.conf 
...
import com.hlg.fcf.web.filter.FworkContextFilter;
import com.hlg.fcf.web.filter.ThreadLocalFilter;
import com.hlg.fcf.web.filter.TokenFilter;
import com.hlg.fcf.web.resolver.RequestParamOrBodyArgumentResolver;
 ...
 * @author changwei 
 */
@Configuration(com.hlg.fcf.Constants.FRAME_BEAN_PREFIX + "SpringWebConfig")
@MvcConditional
