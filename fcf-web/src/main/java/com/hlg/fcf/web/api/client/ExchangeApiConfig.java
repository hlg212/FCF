...
import com.hlg.fcf.model.mq.Binding;
import com.hlg.fcf.model.mq.Exchange;
import com.hlg.fcf.model.mq.MqPageInfo;
...
class ExchangeApiConfig {
    ...
    @FeignClient(contextId = Constants.ApiContextId.ExchangeApi,name=Constants.APP_APIGATEWAY_MQ,url =Constants.AppFeignUrl.APP_MQ,configuration =MqApiConfig.class)
    public interface ExchangeApi extends com.hlg.fcf.api.mq.ExchangeApi<Exchange> {
