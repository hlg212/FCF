...
public class AccessLogFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException,
		...
		try
		{
			...
			String first = HttpServletHelper.getRequest().getHeader(FrameCommonConstants.HTCF_FEIGN_REQUEST_KEY);
			...
			{
				alog = create();
				HttpServletHelper.getRequest().setAttribute(FrameCommonConstants.HTCF_ACCESS_ID,alog.getId());
			}
			chain.doFilter(request, response);
		}
		catch (Exception e)
	...
	private class HttpAccessContext implements AccessContext
	{
		...
		public String getAccessId() {
			String accessId = HttpServletHelper.getRequest().getHeader(FrameCommonConstants.HTCF_ACCESS_ID);
			if( StringUtils.isEmpty(accessId) )
			{
				accessId = (String)HttpServletHelper.getRequest().getAttribute(FrameCommonConstants.HTCF_ACCESS_ID);
			}
