...
import io.hlg212.fcf.model.basic.IRes;
...
public interface AuthApi {
    ...
    @CacheableReadOnly(key = io.hlg212.fcf.cache.Constants.AuthKey.getAuthoritysByUserId_spel)
    ...
    @CacheableReadOnly(key = io.hlg212.fcf.cache.Constants.AuthKey.getAllAuthoritysByUserId_spel)
    ...
    @CacheableReadOnly(key = io.hlg212.fcf.cache.Constants.AuthKey.getMenuByUserId_spel)
    ...
    @CacheableReadOnly(key = io.hlg212.fcf.cache.Constants.AuthKey.getAnonymousUrls_spel)
    ...
    @CacheableReadOnly(key = io.hlg212.fcf.cache.Constants.AuthKey.getAppsByUserId_spel)
