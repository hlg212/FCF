 ...
 * @date 2021年1月11日
 */
@FeignClient(contextId = Constants.ApiContextId.DataAuthorityConfigSetInfoApi,name=Constants.ApiName.DataAuthorityConfigSetInfoApi, url=Constants.ApiUrl.DataAuthorityConfigSetInfoApi)
